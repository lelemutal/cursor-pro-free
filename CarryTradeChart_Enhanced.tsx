...
import { ResponsiveContainer, ScatterChart, CartesianGrid, XAxis, YAxis, Tooltip, Scatter, LineChart, Line, Area, AreaChart, ComposedChart } from 'recharts';
...
const CarryTradeChart: React.FC<CarryTradeChartProps> = ({ data, bandsData, mepRate, onMepRateChange }) => {
  ...
  // Efecto de pulse cada 3 segundos
  useEffect(() => {
      ...
      <div className="flex justify-between items-start mb-6 relative z-10">
        <div className="space-y-2">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <div className="text-center p-2 bg-brand-accent/10 rounded-lg border border-brand-accent/20">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-dark-bg/30 to-dark-card/20 backdrop-blur-sm border border-brand-accent/10 shadow-inner">
        ...
        <div style={{ width: '100%', height: 520 }} className="relative">
          <ResponsiveContainer>
            ...
            >
              <defs>
                {/* Gradiente para el área entre bandas */}
                ...
                {/* Gradiente animado para las líneas */}
